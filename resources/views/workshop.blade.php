...
<html lang="en"><head>
    <meta charset="UTF-8">
    <title>Interior Experience</title>
          ...
          <div class="col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="view overlay">
                <img src="{{asset('uploads')}}/{{$ie->gambar}}" class="card-img-top" alt="" style="width :540px; height :360px;">
                <a href="/workshop2/{{$ie->id}}" target="_blank">
              ...
              <div class="card-body">
                <!--Title-->
                <h4 class="card-title">{{$ie->judul}}</h4>
                <!--Text-->
                <p class="card-text">{{$ie->isi}}...</p>
                <a href="/workshop2/{{$ie->id}}" target="_blank" class="btn btn-color btn-md waves-effect waves-light">Read More
                </a>
              </div>
