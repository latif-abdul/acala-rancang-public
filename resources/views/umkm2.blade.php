          ...
          <div class="col-md-12">
            ...
            <div class="card card-cascade wider reverse">
              ...
              <div class="card-body card-body-cascade text-center">
                <h2><a><strong>{{$u->nama}}</strong></a></h2>
        ...
        <div class="jumbotron p-5 text-center text-md-left author-box wow fadeIn" data-wow-delay="0.3s">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-2 mb-md-0 mb-4">
              <img src="{{asset('uploads')}}/{{$u->gambar}}" class="img-fluid rounded-circle z-depth-2">
            </div>
            <!--Author Data-->
            <div class="col-12 col-md-10">
              <h5 class="font-weight-bold dark-grey-text mb-3">
               ...
               <div class="personal-sm pb-3">
                <a class="fb-ic pr-2" href="www.facebook.com/{{$u->facebook}}"><i class="fab fa-facebook-f mr-2"> </i></a>
                <a class="tw-ic pr-2" href="www.twitter.com/{{$u->twitter}}"><i class="fab fa-twitter mr-2"> </i></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4 col-md-12 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!--Title-->
                <h4 class="card-title">{{$sgt->nama}}</h4>
                <hr>
                <!--Text-->
                <p class="card-text">{{$sgt->bio}}</p>
                <a class="link-text" href="/umkm2/{{$sgt->id}}">
