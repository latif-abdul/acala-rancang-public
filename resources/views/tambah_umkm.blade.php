...
<div class="card" id="reg">
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <!-- Form -->
        <form class="text-center md-form" id="upload" style="color: #757575;" action="/admin/simpanUmkm" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
            ...
            <!-- E-mail -->
            <div class="md-form mt-0">
                <textarea id="form7" class="md-textarea form-control" rows="20" name="bio"></textarea>
  <label for="form7">Bio</label>
            </div>
			<div class="md-form">
                        <input type="text" id="fb" class="form-control" name="fb">
