...
<div class="card" id="reg">
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <!-- Form -->
        <form class="text-center md-form" id="upload" style="color: #757575;" action="/admin/simpanAuthor" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
         
                    <!-- First name -->
                    <div class="md-form">
                        <input type="text" id="materialRegisterFormJudul" class="form-control" name="nama">
                    ...
                    <!-- Last name -->
                    <div class="md-form">
                        <input type="text" id="materialRegisterFormFb" class="form-control" name="fb">
			...
			<div class="md-form mt-0">
                <input type="text" id="GooglePlus" class="form-control" name="GooglePlus">
            ...
            <!-- E-mail -->
            <div class="md-form mt-0">
                <textarea id="form7" class="md-textarea form-control" rows="5" name="bio"></textarea>
